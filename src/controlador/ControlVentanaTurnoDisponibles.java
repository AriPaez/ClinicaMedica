...
public class ControlVentanaTurnoDisponibles implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(botonElegido==ventanaTurnosDisponibles.getFiltrar())
		{
			...
			try
			{
				...
				while(tabla.next())
				{
					ventanaTurnosDisponibles.getTurnosPacientes().append(tabla.getDate(1)+" "+tabla.getFloat(2)
					+" "+tabla.getFloat(3)+" "+tabla.getString(4)+" "+tabla.getString(5)+" "+tabla.getString(6)+" "+
